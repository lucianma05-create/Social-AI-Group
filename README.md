...
| 年份 | 会议/期刊 | 论文 | 链接 | 摘要 | 代码 |
| --- | --- | --- | --- | --- | --- |
| 2025 | arXiv | A-Mem: Agentic Memory for LLM Agents | [查看](https://arxiv.org/abs/2502.12110) | [摘要](paper/Memory-arXiv-2025-A-Mem%3A%20Agentic%20Memory%20for%20LLM%20Agents.md) | [代码](https://github.com/WujiangXu/AgenticMemory) |
| 2026 | ICLR | MemAgent: Reshaping Long-Context LLM with Multi-Conv RL-based Memory Agent | [查看](https://arxiv.org/abs/2507.02259) | [摘要](paper/Memory-ICLR-2026-MemAgent%3A%20Reshaping%20Long-Context%20LLM%20with%20Multi-Conv%20RL-based%20Memory%20Agent.md) | [代码](https://github.com/BytedTsinghua-SIA/MemAgent) |
...
| 2025 | arxiv | MAPO: Mixed Advantage Policy Optimization for Long-Horizon Multi-Turn Dialogue | [查看](https://arxiv.org/pdf/2603.06194) | [摘要](paper/PD-arxiv-2025-MAPO%3A%20Mixed%20Advantage%20Policy%20Optimization%20for%20Long-Horizon%20Multi-Turn%20Dialogue.md) | [代码](https://github.com/2200xiaohu/MAPO) |
